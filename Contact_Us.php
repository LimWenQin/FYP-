...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $title = htmlspecialchars(trim($_POST['title'])); // Subject 换成了 Title
    ...
    if (empty($errors)) {
        // 插入到 contact_messages 表 (增加了 Attachment 列)
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* 文件上传样式 */
        .file-upload-wrapper { position: relative; border: 2px dashed #e0e0e0; padding: 20px; text-align: center; border-radius: 6px; background: #fafafa; }
        .file-upload-wrapper:hover { border-color: #d32f2f; background: #fff5f5; }
            ...
            <div class="contact-info">
                ...
                <div class="info-item">
                    ...
                    <div class="info-details">
                        ...
                        <br><span style="font-size: 0.9em; color: #666;">Click to WhatsApp</span>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="file-upload-wrapper">
                            <input type="file" id="attachment" name="attachment" class="form-control" style="border:none; padding: 0;">
