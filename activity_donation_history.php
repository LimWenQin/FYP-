...
// --- 1. 获取活动信息 ---
$actSql = "SELECT Activity_Name, Activity_TargetAmount FROM activity WHERE Activity_ID = $activityId";
...
// --- 5. 构建列表 SQL 查询 ---
$conditions = [];
$conditions[] = "o.Activity_ID = $activityId";
...
<head>
    <meta charset="UTF-8">
    <title>Donation History - <?php echo htmlspecialchars($activityName); ?></title>
