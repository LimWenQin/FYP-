...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: admin_management_page.php");
    exit();
}
...
if ($result->num_rows == 0) {
    header("Location: admin_management_page.php?error=" . urlencode("Admin not found."));
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_admin'])) {
    ...
    if (isset($_FILES['profile_picture']) && $_FILES['profile_picture']['error'] == 0) {
        ...
        if ($uploadedPath) {
             $imageUpdateSQL = ", Admin_ProfilePicture = '$uploadedPath'";
        }
    }
...
<head>
    ...
    <title>Admin Details - Donation Management System</title>
...
<body>
    ...
    <div id="successModal" class="modal-overlay" style="display: <?php echo $saveSuccess ? 'flex' : 'none'; ?>;">
        <div class="success-modal">
            ...
            <p style="color: #666; line-height: 1.5;">Admin details have been successfully updated.</p>
            <div class="modal-btn-group">
                <a href="admin_management_page.php" class="btn-cancel" style="border: 1px solid #ddd; background: white; color: #555;">Return to List</a>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="dashboard-content" style="padding-top: 10px;">
            <div class="page-header-compact">
                <a href="admin_management_page.php" class="back-btn"><i class="fas fa-arrow-left"></i> Back to Admin Management</a>
                <div class="header-title">
                    <h1>Admin Details</h1>
                    <p>View or modify administrator information.</p>
                </div>
            </div>

            <div class="form-container">
                <form id="editAdminForm" action="admin_view_edit.php?id=<?php echo $adminId; ?>" method="POST" enctype="multipart/form-data" onsubmit="return validateForm('edit')" novalidate>
                        ...
                        <div style="display: flex; flex-direction: column; align-items: center;">
                            <div class="profile-picture-preview" id="edit-preview-container" onclick="openImageViewer()" style="cursor: pointer;">
                                <?php if (!empty($admin['Admin_ProfilePicture']) && file_exists($admin['Admin_ProfilePicture'])): ?>
                                    <img src="<?php echo $admin['Admin_ProfilePicture']; ?>" alt="Profile">
                                <?php else: ?>
                                    <div class="default-avatar-icon"><i class="fas fa-user-shield"></i></div>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_Name']); ?>" readonly oninput="validateName(this)">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="email" name="email" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_Email']); ?>" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="phone-format">
                                ...
                                <input type="text" id="edit_contact" name="contact" class="form-input phone-input" value="<?php echo str_replace('+60', '', $admin['Admin_ContactNumber']); ?>" readonly maxlength="11">
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="ic_number" name="ic_number" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_ICNUMBER']); ?>" maxlength="14" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="dob" name="dob" class="form-input" value="<?php echo $admin['Admin_DOB']; ?>" readonly onchange="validateAge('dob')">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Address Line 1</label>
                        <input type="text" name="address1" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_Address1']); ?>" readonly>
                        <span class="form-guide edit-controls">House unit no., floor, building, street name.</span>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Address Line 2</label>
                        <input type="text" name="address2" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_Address2']); ?>" readonly>
                        <span class="form-guide edit-controls">Residential area, village, or section.</span>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Address Line 3</label>
                        <input type="text" name="address3" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_Address3']); ?>" readonly>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="city" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_City']); ?>" readonly>
                        </div>
                        <div class="form-group">
                            ...
                            <select id="state" name="state" class="form-select" disabled>
                                ...
                                <?php foreach($malaysiaStates as $s): ?>
                                    <option value="<?php echo $s; ?>" <?php if($admin['Admin_State'] == $s) echo 'selected'; ?>><?php echo $s; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="postal_code" name="postal_code" class="form-input" value="<?php echo htmlspecialchars($admin['Admin_PostalCode']); ?>" readonly oninput="detectStateFromPostcode('postal_code', 'state')">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="role" name="role" class="form-select" disabled>
                                <option value="Admin" <?php if($admin['Admin_Role'] == 'Admin') echo 'selected'; ?>>Admin</option>
                                <option value="Super Admin" <?php if($admin['Admin_Role'] == 'Super Admin') echo 'selected'; ?>>Super Admin</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-select" disabled>
                                <option value="Active" <?php if($admin['Admin_Status'] == 'Active') echo 'selected'; ?>>Active</option>
                                <option value="Inactive" <?php if($admin['Admin_Status'] == 'Inactive') echo 'selected'; ?>>Inactive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="comment" class="form-textarea" rows="3" readonly><?php echo htmlspecialchars($admin['Admin_Comment']); ?></textarea>
                        <span class="form-guide edit-controls">Optional notes.</span>
                    </div>

                    <div class="button-group edit-controls">
                        <a href="admin_view_edit.php?id=<?php echo $adminId; ?>" class="btn-cancel"><i class="fas fa-times"></i> Cancel</a>
    ...
    <script>
        ...
        function toggleEditMode(isEdit) {
            ...
            document.querySelectorAll('.form-input, .form-textarea').forEach(el => {
                if (el.name !== 'country') el.readOnly = !isEdit; 
            });
            ...
            if (!isEdit) {
                ...
                <?php if (!empty($admin['Admin_ProfilePicture']) && file_exists($admin['Admin_ProfilePicture'])): ?>
                    container.innerHTML = `<img src="<?php echo $admin['Admin_ProfilePicture']; ?>" alt="Profile">`;
                <?php else: ?>
                    container.innerHTML = `<div class="default-avatar-icon"><i class="fas fa-user-shield"></i></div>`;
                <?php endif; ?>
            }
        }
        ...
        function validateForm(type) {
            ...
            if (!nameVal) { showFieldError(nameId, "Required."); hasError = true; if(!firstErrorMsg) firstErrorMsg="Name required."; }
            ...
            if (!contactVal) { showFieldError(contactId, "Required."); hasError = true; if(!firstErrorMsg) firstErrorMsg="Contact required."; }
            else { 
            ...
            if (!icVal) { showFieldError(icId, "Required."); hasError = true; if(!firstErrorMsg) firstErrorMsg="IC required."; } 
            ...
            if (!dobVal) { showFieldError(dobId, "Required."); hasError = true; if(!firstErrorMsg) firstErrorMsg="DOB required."; }
            else if (!isAgeValid(dobVal)) { showFieldError(dobId, "Must be > 18."); hasError = true; if(!firstErrorMsg) firstErrorMsg="Admin must be > 18."; }
        ...
        function openImageViewer() {
            ...
            if (img) {
                ...
                placeholder.innerHTML = '<i class="fas fa-user-shield"></i>'; 
            }
