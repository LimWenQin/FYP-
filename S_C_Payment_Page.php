...
// 如果 URL 没参数，尝试从 Session 恢复 (比如从下一页点 Back 回来)
...
<style>
    ...
    .hero {
        ...
        background-image: url('images/hero_5.jpg'); /* 可以根据 $mode 动态换图，这里先用统一的 */
    ...
    .main-title { font-size: 1.8rem; font-weight: 700; color: #222; margin-bottom: 15px; line-height: 1.3; }
    .main-desc { font-size: 1rem; color: #555; line-height: 1.6; margin-bottom: 25px; text-align: justify; }
    ...
    .input-custom { width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 6px; margin-bottom: 20px; font-size: 16px; transition: 0.3s; text-align: center;}
    ...
    .tax-note { font-size: 12px; color: #666; margin-top:0; }
