...
<style>
    ...
    .summary-card {
        ...
        padding: 30px;
        border-radius: 8px;
        border-left: 5px solid #e16161ff;
    }
    .summary-item {
        display: flex;
    ...
    .summary-value { font-weight: bold; color: #e16161ff; font-size: 1.1rem; }
    ...
    .btn-pay:hover { background-color: #f79c34ff; color: white; }
</style>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 mb-5">
                <div class="mb-4">
                    <h3 class="text-cursive mb-4" style="color: #e16161ff;">Donation Summary</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="payment-option">
                            <img src="BankTransfer.jpg" alt="Bank Transfer" class="payment-img">
