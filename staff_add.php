...
<head>
    ...
    <title>Add Staff - Donation Management System</title>
    ...
    <style>
        ...
        .profile-picture-preview { 
            ...
            justify-content: center; overflow: visible; position: relative; 
        } 
...
<body>
    ...
    <div id="successModal" class="modal-overlay" style="display: <?php echo $saveSuccess ? 'flex' : 'none'; ?>;">
        <div class="success-modal">
            ...
            <p style="color: #666; line-height: 1.5;">Staff member has been successfully added to the system.</p>
            <div class="modal-btn-group">
                <a href="staff_management_page.php" class="btn-clear" style="border: 1px solid #ddd;">Return to List</a>
        ...
        <div class="dashboard-content" style="padding-top: 10px;">
            <div class="page-header-compact">
                ...
                <div class="header-title">
                    <h1>Add New Staff</h1>
                    <p>Create a new staff account with access permissions.</p>
                </div>
            </div>

            <div class="form-container">
                <form id="addStaffForm" action="staff_add.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm('add')" novalidate>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="email" name="email" class="form-input" required placeholder="e.g. user@example.com">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="role" class="form-input readonly-field" value="Staff" readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="comment" class="form-textarea" rows="3" placeholder="e.g. Staff specific skills or notes"></textarea>
    ...
    <script>
        ...
        function validateForm(type) {
            ...
            if (!contactVal) { showFieldError(contactId, "This field is required."); hasError = true; if(!firstErrorMsg) firstErrorMsg = "Contact is required."; }
                ...
                if (phoneMsg) { showFieldError(contactId, phoneMsg); hasError = true; if(!firstErrorMsg) firstErrorMsg = phoneMsg; }
            }
        ...
        // --- Image Helpers with Remove Button ---
