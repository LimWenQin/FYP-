...
(2, 'Love Bridge', '+6011-11190233', '030517-01-0373', 'lovebridge1201@gmail.com', '$2y$10$yRnaaAeLqift7YsGSVjF8.70L7.tQMHtDFrLkD7gbeapVr4KLfHR2', '2003-05-17', '11， jalan silat lincah 10', 'Taman Selesa Jaya', '', 'Skudai', 'Johor', '81300', 'Malaysia', 'uploads/profiles/admin_2_1767838052.jpg', 'Super Admin', 'Active', '2026-01-31 15:14:32', '2025-12-06 17:31:10', '2026-01-31 15:14:32', 'Added via admin management system', 0, '2026-01-31 15:13:48', 0, 0),
...
(50, 'LIM WEN QIN', '011-11234567', '', 'lll8694798586@gmail.com', 200.00, 20, 'MYR', 'TNG eWallet', 'Success', 'Completed', 'TXN-TNG-20260131005900-958', 'One-time', 'Completed', 'Not_Requested', 0, '2026-01-31 00:59:00', '2026-01-31 00:59:00', 12, 51, NULL, NULL, 7);
...
(51, 'TNG eWallet', 'Success', 'TXN-TNG-20260131005900-958', 200.00, '2026-01-31 00:59:00', 'TNG eWallet', 'QR Payment', NULL, '2026-01-31 00:59:00');
...
CREATE TABLE `redemption_order` (
  ...
  `Redemption_Created_At` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `reward_item` (
  ...
  `Reward_Category_Note` varchar(255) DEFAULT NULL,
...
(8, 'AP-008', 'Tie-Dye Tote Bag', 'Apparel', NULL, 'Canvas tote bag featuring unique tie-dye patterns. Reusable and stylish.', 18, 'Youth Art Center', 60, NULL, 'Active', 'reward_1768482725_6968e7a5517f8.jpg'),
(9, 'HO-009', 'Coconut Shell Bowl', 'Household', NULL, 'Polished natural coconut shell bowl, perfect for smoothie bowls or decor.', 12, 'Island Crafts', 45, NULL, 'Active', 'reward_1768482715_6968e79b4b5cb.jpg'),
(10, 'OT-010', 'Hand-Stitched Notebook', 'Others', NULL, 'A5 notebook with recycled paper and hand-stitched binding.', 15, 'Green Stationers', 35, NULL, 'Active', 'reward_1768482703_6968e78f84c20.jpg'),
(11, 'HA-011', 'Macrame Wall Hanging', 'Handicraft', NULL, 'Bohemian style wall decoration made from cotton rope.', 45, 'Knotty Arts', 12, NULL, 'Low Stock', 'reward_1768482689_6968e7819a019.jpg'),
(12, 'AP-012', 'Embroidered Pouch', 'Apparel', NULL, 'Zipper pouch with detailed floral embroidery. Great for cosmetics.', 22, 'Needlework Aunties', 28, NULL, 'Active', 'reward_1768482676_6968e774c0dc3.jpg'),
(13, 'HO-013', 'Bamboo Cutlery Set', 'Household', NULL, 'Reusable bamboo spoon, fork, and straw in a cloth pouch.', 10, 'EcoLife', 5, NULL, 'Low Stock', 'reward_1768482658_6968e76232363.jpg'),
(14, 'OT-014', 'Resin Flower Bookmark', 'Others', NULL, 'Clear resin bookmark with pressed real dried flowers inside.', 8, 'Floral Press', 0, NULL, 'Inactive', 'reward_1768482645_6968e755f30d3.jpg'),
(15, 'HO-015', 'Hand-Painted Tiffin', 'Household', NULL, 'Classic metal tiffin carrier painted with retro floral patterns.', 50, 'Retro Vibes', 9, NULL, 'Low Stock', 'reward_1768482635_6968e74b2b33f.jpg'),
(16, 'HA-016', 'Crochet Plushie Bear', 'Handicraft', NULL, 'Cute handmade crochet bear doll. Safe for kids.', 30, 'Grandma Stitches', 20, NULL, 'Active', 'reward_1768482624_6968e7407d579.jpg'),
(17, 'AP-017', 'Upcycled Denim Purse', 'Apparel', NULL, 'Coin purse made from recycled denim jeans.', 10, 'Recycle Works', 40, NULL, 'Active', 'reward_1768482609_6968e731d20f6.jpg'),
(18, 'EL-018', 'Wood Carved Phone Stand', 'Electronics', NULL, 'Simple wooden stand carved from leftover timber. Fits most phones.', 15, 'Woody Crafts', 15, NULL, 'Active', 'reward_1768482600_6968e72873ec4.jpg'),
(19, 'HO-019', 'Ceramic Mug ', 'Household', NULL, 'Imperfection is beauty. Hand-thrown ceramic mug with unique glaze.', 25, 'Earth Pottery', 18, NULL, 'Active', 'reward_1768482579_6968e7133db7e.jpg'),
(20, 'HA-020', 'Traditional Kite ', 'Handicraft', NULL, 'Miniature decorative Wau Bulan. Not for flying, for display only.', 40, 'Heritage Fly', 50, NULL, 'Active', 'reward_1768482561_6968e70115ced.jpg');
...
(2, NULL, 'EMERGENCY: \"Operation Ark\" Launched for East Coast Flood Victims', 'Love Bridge Pahang', 'News', 'The Northeast Monsoon has struck hard. Following continuous heavy rainfall, severe flooding has displaced over 5,000 families in Kelantan and Terengganu. In response, Love Bridge has officially activated \"Operation Ark\" from our KL Main Operations Hub.\r\n\r\nOur Quick Response Team (QRT) is currently deploying inflatable boats to reach cut-off areas in Kota Bharu. We are urgently appealing for public donations to procure clean water tablets, hygiene kits, and dry food packs. Every minute counts in disaster relief. Join us to be the lifeline for those stranded in the floods.', '[\"uploads\\/stories\\/1768137483_Gemini_Generated_Image_lm00oxlm00oxlm00.png\"]', 'Published', '2026-01-11 21:18:03', '2026-01-30 01:17:15'),
...
(1, 'Mr. Thong Yuen Zhen', 'Executive Director', 'Founded this donation platform in community', '[\"images\\/team_1769797497_WhatsApp Image 2025-05-21 at 00.58.05_6c09f988.jpg\"]', '2026-01-12 06:21:16'),
(2, 'Mr. Lim Wen Qin', 'Executive Director', 'Former corporate leader turned full-time humanitarian', '[\"images\\/team_1769797525_STUDENT.jpg\"]', '2026-01-12 06:21:16'),
(3, 'Mr. Ronald Tan Bin Hong', 'Executive Director', 'Specialized in community development and disaster response', '[\"images\\/team_1768483579_Ronald Tan Bin Hong.jpeg\"]', '2026-01-12 06:21:16');
...
--
ALTER TABLE `admin_notifications`
  MODIFY `AdminNotification_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;
