...
(6, 'Lim Wen Qin', '+6011-19848732', '060504-03-0201', 'qinwenlin989@gmail.com', '$2y$10$CpJi2tClyKoRBpDt4sR4B.QRW/yTjENkBVnKLReWKaGGts1eAKAUy', '2006-05-04', '', '', '', '', '', '', 'Malaysia', NULL, 'Admin', 'Active', '2026-01-11 18:55:28', '2026-01-09 13:44:39', '2026-01-11 18:55:28', '', 0, NULL, 0, 0);
...
(6, 'RONALD TAN BIN HONG', '012-7212535', '050404011183', 'ronaldtan0404@gmail.com', '$2y$10$xOPon039anG.Ft.X5qZCjuMJ.zwoKZBfFpWlAm61hiBHvnJZaHamK', 80.00, 'No19.jalan melawati 19, taman melawati', 'taman melawati', 'Skudai', 'Johor Bahru', 'Johor', '81300', 'Malaysia', '2005-04-04', '', '2026-01-11 21:21:48', NULL, NULL, 0, 0, NULL);
...
(5, 'RONALD TAN BIN HONG', '012-7212535', '050404011183', 'ronaldtan0404@gmail.com', 50.00, 0, 'MYR', 'TNG eWallet', 'Success', 'Completed', 'TXN-20260111215338-973', 'One-time', 'Completed', 'Requested', 0, '2026-01-11 21:53:38', '2026-01-11 21:53:38', 6, 6, NULL, NULL, 8),
...
--
ALTER TABLE `admin_notifications`
  MODIFY `AdminNotification_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `point`
  MODIFY `Points_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `wallet_transaction`
  MODIFY `Wallet_Trans_ID` int(11) NOT NULL AUTO_INCREMENT;
