...
(3, 'Penang Outreach', '', NULL, NULL, '', 0, NULL, '15, Jalan Georgetown', NULL, NULL, 'Georgetown', 'Penang', '10200', 'Malaysia', '04-2223333', '', 'Northern region support center.', NULL, 1, 'Open', '2025-12-15 23:02:23', 0);
...
--
ALTER TABLE `admin_notifications`
  MODIFY `AdminNotification_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
